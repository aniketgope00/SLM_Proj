...
[Open In App](https://geeksforgeeksapp.page.link/?link=https://www.geeksforgeeks.org/cnn-introduction-to-pooling-layer/?type%3Darticle%26id%3D330684&apn=free.programming.programming&isi=1641848816&ibi=org.geeksforgeeks.GeeksforGeeksDev&efr=1)

[Next Article:\\
\\
CIFAR-10 Image Classification in TensorFlow\\
\\
![Next article icon](https://media.geeksforgeeks.org/auth-dashboard-uploads/ep_right.svg)](https://www.geeksforgeeks.org/cifar-10-image-classification-in-tensorflow/)
...
For a feature map with dimensions nh×nw×ncn\_h \\times n\_w \\times n\_cnh​×nw​×nc​, the dimensions of the output after a pooling layer are:

(nh–f+1s)×(nw–f+1s)×nc\\left( \\frac{n\_h – f + 1}{s} \\right) \\times \\left( \\frac{n\_w – f + 1}{s} \\right) \\times n\_c(snh​–f+1​)×(snw​–f+1​)×nc​

where:

- nhn\_hnh​ → height of the feature map
- nwn\_wnw​ → width of the feature map
- ncn\_cnc​ → number of channels in the feature map
- fff → size of the pooling filter
- sss → stride length
...
Global pooling reduces each channel in the feature map to a single value, producing a 1×1×nc1 \\times 1 \\times n\_c1×1×nc​ output. This is equivalent to applying a filter of size nh×nwn\_h × n\_wnh​×nw​.
...
1. **Define a Pooling Window (Filter)**: The size of the pooling window (e.g., 2×2) is chosen, along with a stride (the step size by which the window moves). A common choice is a 2×2 window with a stride of 2, which reduces the feature map size by half.
...
[Next Article](https://www.geeksforgeeks.org/cifar-10-image-classification-in-tensorflow/)

[CIFAR-10 Image Classification in TensorFlow](https://www.geeksforgeeks.org/cifar-10-image-classification-in-tensorflow/)

[![author](https://media.geeksforgeeks.org/auth/profile/wjtm901f62m4dfrw5sg3)](https://www.geeksforgeeks.org/user/savyakhosla/)

[savyakhosla](https://www.geeksforgeeks.org/user/savyakhosla/)
...
![Lightbox](https://www.geeksforgeeks.org/cnn-introduction-to-pooling-layer/)
...
[iframe](https://td.doubleclick.net/td/ga/rul?tid=G-DWCCJLKX3X&gacid=1802268674.1745057080&gtm=45je54g3h1v884918195za200&dma=0&gcd=13l3l3l3l1l1&npa=0&pscdl=noapi&aip=1&fledge=1&frm=0&tag_exp=102803279~102813109~102887800~102926062~103027016~103051953~103055465~103077950~103106314~103106316&z=188202084)
...
[iframe](https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LexF0sUAAAAADiQjz9BMiSrqplrItl-tWYDSfWa&co=aHR0cHM6Ly93d3cuZ2Vla3Nmb3JnZWVrcy5vcmc6NDQz&hl=en&v=ItfkQiGBlJCsN5gUMmHbpLEb&size=normal&cb=h9ekzs9c0lp)
...
[iframe](https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LexF0sUAAAAADiQjz9BMiSrqplrItl-tWYDSfWa&co=aHR0cHM6Ly93d3cuZ2Vla3Nmb3JnZWVrcy5vcmc6NDQz&hl=en&v=ItfkQiGBlJCsN5gUMmHbpLEb&size=normal&cb=ez82j5s4ongm)
...
[iframe](https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LdMFNUZAAAAAIuRtzg0piOT-qXCbDF-iQiUi9KY&co=aHR0cHM6Ly93d3cuZ2Vla3Nmb3JnZWVrcy5vcmc6NDQz&hl=en&v=ItfkQiGBlJCsN5gUMmHbpLEb&size=invisible&cb=povpspup3s0x)